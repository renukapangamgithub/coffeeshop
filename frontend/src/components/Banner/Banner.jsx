          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Our premium blend coffee is made from the finest beans, carefully selected for their rich flavor and aroma. Whether you prefer a smooth espresso or a bold Americano, our coffee is designed to provide the perfect balance of strength and smoothness in every cup.
                </p>
